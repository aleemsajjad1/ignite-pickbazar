...
import QuestionsList from '@/components/question/question-list';
...
export default function TypesPage() {
  ...
  return (
    <>
      ...
      <QuestionsList listOfBrands={types} onOrder={setOrder} onSort={setColumn} />
    </>
  );
}
