...
import { typeValidationSchema } from './invoice-validation-schema';
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="my-5 flex flex-wrap sm:my-8">
        <Description
          ...
          details={t('Add New Invoice Description')}
      ...
      <div className="mb-4 text-end">
        ...
        <Button>
          {initialValues ? t('form:button-label-update-group') : t('Add Invoice')}
        </Button>
      </div>
    </form>
  );
